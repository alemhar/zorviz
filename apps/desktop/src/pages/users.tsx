            ...
            <Dialog open={open} onOpenChange={(o) => { if (!o) close(); }}>
                <DialogContent>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-1">
                            <Label htmlFor="upin">{creating ? "PIN (4+ digits)" : "Reset PIN (leave blank to keep)"}</Label>
                            <Input id="upin" type="password" inputMode="numeric" value={pin} onChange={(e) => setPin(e.target.value)} />
                        </div>
                        {!creating && (
