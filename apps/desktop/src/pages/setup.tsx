                        ...
                        <>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div className="space-y-2">
                                    ...
                                    <Input id="pin" type="password" inputMode="numeric" value={pin} onChange={(e) => setPin(e.target.value)} />
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="cpin">Confirm PIN *</Label>
                                    <Input id="cpin" type="password" inputMode="numeric" value={confirmPin} onChange={(e) => setConfirmPin(e.target.value)} />
                                </div>
                            </div>
                        </>
                    )}
