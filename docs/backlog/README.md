...
| Phase 1 — Core Kernel | [backlog](./phase-1-backlog.md) | [completed](./phase-1-completed.md) | ~88% (settings, **data-driven asset types**, **demo seeder/reset**, **schema domain split** done; remaining all deferred: module registry, user-mgmt UI, hardware IO) |
